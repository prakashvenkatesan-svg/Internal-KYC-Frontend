        ...
        if (
          ...
          navigate("/digilocker-details", {
            state: {
              ...
              digilockerXml: aadhaarResponse.data?.data?.rawXml || "",
              digilockerSourceData:
                aadhaarResponse.data?.data?.rawSourcePayload ||
                aadhaarResponse.data?.data?.provider_response ||
                aadhaarResponse.data?.data ||
                null,
            },
          });
        }
