...
// import AdminAssignRM from "./Pages/admin/AssignRM";
...
import PanUpload from "./Pages/kyc/kyc-verification/PanUpload";
...
const Layout = () => {
  ...
  const hideFooter =
    ...
    location.pathname === "/uploadpancard" ||
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/uploadpancard' element={<PanUpload />} />
